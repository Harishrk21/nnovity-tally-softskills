    ...
    <div className="social-float-bar fixed bottom-4 right-3 z-40 flex flex-col gap-2.5 sm:bottom-5 sm:right-4 sm:gap-3 md:bottom-8 md:right-6">
      {items.map((item, index) => (
        <a
          ...
          className={`group flex h-11 w-11 items-center justify-center rounded-full text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl sm:h-12 sm:w-12 ${item.className}`}
